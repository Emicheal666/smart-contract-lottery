...
!developmentChains.includes(network.name)
  ...
  : describe("Raffle unit test", function () {
      ...
      describe("constructor", function () {
        it("initializing our raffle", async function () {
      ...
      describe("checkUpkeep", function () {
        it("returns false if people didnt send enough ETH", async function () {
          await network.provider.send("evm_increaseTime", [
            interval.toNumber() + 1,
          ]);
          await network.provider.send("evm_mine", []);
      ...
      describe("fulfillRandomWords", function () {
        ...
        it("picks a winner, reset the lottery, and sends money", async function () {
          ...
          const startingTimeStamp = await raffle.getLatestTimeStamp(); // keeping note of current timestap
